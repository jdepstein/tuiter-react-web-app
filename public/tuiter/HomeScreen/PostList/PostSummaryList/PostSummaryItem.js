        ...
        `<div class=" row wd-margin-top-12px wd-padding-bottom-12px">
            ...
            ${item.trending_tag ?`
               <div class="float-start 
                ${item.promotion ? 'fw-bold text-white' : "text-secondary" } text-wrap">
               ${item.trending_tag}
               </div><br>` : ''
            }
 
            <div class="float-start  ${item.promotion ? 'text-secondary' : "fw-bold text-white" }  text-wrap">
                ${item.title}
            </div><br>
            
           ${item.tuits ?`
               <div class="float-start text-secondary text-wrap">
                ${item.tuits}
               </div><br>` : ''
            }
